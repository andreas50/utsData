...
#'
#' @source This dataset was imported by \code{\link{download_sunspots_daily}} in June 2018 from \url{http://www.sidc.be/silso/datafiles}. For a detailed description see \url{http://www.sidc.be/silso/infosndtot}.
